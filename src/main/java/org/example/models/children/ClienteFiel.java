...
public class ClienteFiel extends Cliente {
    ...
    public ClienteFiel(Integer id, String nombreApellido, String email, LocalDate fechaRegistro, String telefono, LocalDate fechaCumpleanos, Integer numeroComprasMes) {
